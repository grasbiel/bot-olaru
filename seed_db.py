...
SQL_SEED = [
    ...
    f"INSERT INTO usuarios (nome, email, senha_hash, perfil) VALUES ('Administrador', 'admin@olaru.com', '{BCRYPT_PASS}', 'ADMIN') ON CONFLICT (email) DO NOTHING;",
    f"INSERT INTO usuarios (nome, email, senha_hash, perfil) VALUES ('Gerente de Obras', 'gerente@olaru.com', '{BCRYPT_PASS}', 'GERENTE') ON CONFLICT (email) DO NOTHING;",
    f"INSERT INTO usuarios (nome, email, senha_hash, perfil) VALUES ('Técnico Carlos', 'carlos@olaru.com', '{BCRYPT_PASS}', 'TECNICO') ON CONFLICT (email) DO NOTHING;",
